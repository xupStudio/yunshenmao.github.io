/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: adf38a5b9fa2da08fff0fd39c39f40c8)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	WELCOME_DELAY_MINUTES: "5";
	SENDER_EMAIL: "monthly@yunshenmao.com";
	SENDER_NAME: "雲深貓園";
	REPLY_TO_EMAIL: "xup654m42@gmail.com";
	SITE_URL: "https://yunshenmao.com";
	FACEBOOK_URL: "https://www.facebook.com/profile.php?id=61579639902271";
	STRIPE_STATUS_PROXY_URL: "https://yunshenmao-checkout.pages.dev/api/subscription-status";
	CUSTOMER_PORTAL_URL: "https://billing.stripe.com/p/login/14A5kD5HJ57bggjcva7wA01";
	STRIPE_WEBHOOK_SECRET: string;
	STRIPE_STATUS_PROXY_TOKEN: string;
	WELCOME_WORKFLOW: Workflow<Parameters<import("./src/index").SubscriberWelcomeWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WELCOME_DELAY_MINUTES" | "SENDER_EMAIL" | "SENDER_NAME" | "REPLY_TO_EMAIL" | "SITE_URL" | "FACEBOOK_URL" | "STRIPE_STATUS_PROXY_URL" | "CUSTOMER_PORTAL_URL" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_STATUS_PROXY_TOKEN">> {}
}
